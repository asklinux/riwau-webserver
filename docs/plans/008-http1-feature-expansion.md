...
See `docs/TODO.md` for current next work. The largest HTTP/1.1 follow-ups are streaming request bodies, response chunking, multipart ranges, Brotli, advanced slow-client protection, richer WebSocket routing, zero-copy static file serving, and broader integration/stress tests.
