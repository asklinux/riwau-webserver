    ...
    return {
        {
            ...
            http1_transport,
            "HTTP/1.1 supports GET/HEAD static files, OPTIONS, POST/PUT/PATCH/DELETE JSON scaffold, Content-Length, chunked decode, keep-alive, basic pipelining, single range, gzip, basic WebSocket echo, WebSocket reverse proxy tunneling, and baseline timeout/rate-limit/security controls."
        },
        {
